 ...
 */
module.exports.Component = registerComponent('no-click-look', {
...
// var {registerComponent} = require('aframe');
...
// module.exports = registerComponent('no-click-look',{
//   dependencies: ['position', 'rotation'],
//   schema: {
//     enabled: { default: true },
...
//     this.controls = new VRControls(this.dolly);
